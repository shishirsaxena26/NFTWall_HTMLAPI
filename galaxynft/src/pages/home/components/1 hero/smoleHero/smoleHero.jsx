import "./smoleHero.css";
import { Link } from "react-router-dom";
import { useState, useEffect } from "react";
import { IoRocketOutline } from "react-icons/io5";

const SmoleHero = ({ Data }) => {
  ...
  return (
    <section id="SHero" className="mb-5 mt-4">
          ...
          <div className="col-12 col-md-6 d-flex justify-content-center">
            <div>
              ...
              <div className="d-none d-md-block">
                ...
                <div className="heroState d-flex justify-content-center">
                  <ul className="list-unstyled d-flex gap-3 text-center">
                    <li>
            ...
            <div>
              ...
              <div className="d-block d-md-none mt-4">
                <div>
                  <Link
                    to="/nfts"
                    className="btnTemp d-flex justify-content-center align-items-center gap-2"
                  >
                    <IoRocketOutline className="IoRocketOutline my-3" />
                    get started
                  </Link>
                </div>
                <div className="heroState d-flex justify-content-center mt-4">
                  <ul className="list-unstyled d-flex gap-3 text-center">
                    <li>
                      <span className="d-block F6">{counter.Fcounter}k+</span>
                      <span className="F4">Total Sale</span>
