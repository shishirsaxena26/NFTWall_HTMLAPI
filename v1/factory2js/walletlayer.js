...
async function pageload() {
	...
	safeABI = await fetch('abi.v1/lib723Common.sol/lib723Common.json?v='+version).then(res => res.json());
	factoryABI = await fetch('abi.v1/Nftwall-Factory.sol/NFTWallFactory.json?v='+version).then(res => res.json());
	RulesABI = await fetch('abi.v1/lib741Rules.sol/lib741Rules.json?v='+version).then(res => res.json());
	NestedABI = await fetch('abi.v1/Nested741.sol/Nested741.json?v='+version).then(res => res.json());
	insABI = await fetch('abi.v1/Nftwall-Instance.sol/NodeInstance.json?v='+version).then(res => res.json());
	ORCABI = await fetch('abi.v1/ORC1155.sol/ORC1155.json?v='+version).then(res => res.json());
...
{debugger;
	...
	let isusr = await window.factorycontract.methods.isuser(u).call();
	debugger;
	return (isusr) ;
}
