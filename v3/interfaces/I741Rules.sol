...
interface I741Rules {
    ...
    function capping() external view returns (uint256 multiple, bool rw, bool ry, bool self, bool yei, bool val);
    ...
    function setCapping(uint256 _multiple, bool _rw, bool _ry, bool _self, bool _yei, bool _val) external;
